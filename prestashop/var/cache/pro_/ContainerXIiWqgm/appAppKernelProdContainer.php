...
class appAppKernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'console.command.public_alias.mailchimp.mailchimppro.customer_sync' => 'getConsole_Command_PublicAlias_Mailchimp_Mailchimppro_CustomerSyncService.php',
            'console.command.public_alias.mailchimp.mailchimppro.order_sync' => 'getConsole_Command_PublicAlias_Mailchimp_Mailchimppro_OrderSyncService.php',
            'console.command.public_alias.mailchimp.mailchimppro.product_sync' => 'getConsole_Command_PublicAlias_Mailchimp_Mailchimppro_ProductSyncService.php',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'esaf1', 'user' => 'root', 'password' => '', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4LDPNvE0o0OycAQ5BFp4hCkovqQ0iK1k54Mo0V7RKrhwT80eWdZawKJnwA1GUOWk'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.secret' => '4LDPNvE0o0OycAQ5BFp4hCkovqQ0iK1k54Mo0V7RKrhwT80eWdZawKJnwA1GUOWk',
            ...
            'console.command.ids' => [
                ...
                9 => 'console.command.public_alias.mailchimp.mailchimppro.customer_sync',
                10 => 'console.command.public_alias.mailchimp.mailchimppro.product_sync',
                11 => 'console.command.public_alias.mailchimp.mailchimppro.order_sync',
            ],
        ];
    }
}
